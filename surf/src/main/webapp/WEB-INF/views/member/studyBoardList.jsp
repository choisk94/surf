    ...
    <div class="body-outer">
        ...
        <div class="long-title">
            ...
            <div style="font-size: 15px; font-weight: normal;">
                <br>
                같은 클래스를 듣거나, 관심사를 지닌 사람들과 스터디를 만들어보세요.<br>
        ...
        <div style="width: 750px; margin: auto; margin-top: 60px;">
            ...
            <div id="topArea" style="overflow: auto;">
                <div class="input-group mb-3" style="width: 60%; float: left;">
                    <input type="text" class="form-control" placeholder="어떤 스터디를 찾고있나요?">
                    <div class="input-group-append">
                        <button class="btn btn-success" type="submit"><i class="fa fa-search"></i></button>
                    </div>
                </div>
                <div style="width: 39%; float: left;" align="right">
                    <button class="btn btn-info">글쓰기 <i class="fas fa-file-alt" style="font-size:15px;"></i> </button>
                </div>
            </div>
            <!-- 정렬 기준 -->
            <div id="selectBy">
            ...
            <div class="text-center">
                <button class="btn btn-secondary" style="width: 200px; border-radius: 10px;">더보기</button>
            </div>
