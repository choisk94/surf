...
<style>
    ...
    .update-page>a:hover{color: orangered;}
    .logout-area>a{
        padding-left: 10px;
        text-decoration: none;
        color: black;
    ...
    .profile>div>a:hover{opacity:0.7;}
</style>
</head>
<body>
    <div id="outer">
